...
let daysbook =
  "https://res.cloudinary.com/dkzds0azx/image/upload/v1652280967/oneful/images/30daysbook_xoqfnj.jpg";

let one_pager =
  " https://res.cloudinary.com/dkzds0azx/image/upload/v1652280883/oneful/images/one_pager-graphic-min_xg0oms.png";
      ...
      <div className="Hsection6">
        <div className="Hsection6_flex">
          <div className="Hsection6_flex_sec_1 container">
            ...
            <div className="Hsection6_join_live_1 ">
        ...
        <div className="Hsection6_Sec_2_flex ">
          ...
          <div className="Hsection6_flex_sec_1 ">
            ...
            <div className="Hsection6_join_live live_3 ">
              <p className="Hsection6_join_Challenge_p1">
                {" "}
                Join The Challenge Now!
              </p>
              <p className="Hsection6_join_Challenge_p2">
                I Want Daily Training, LIVE Coaching and Accountability, From
                Day 1 to Day 30{" "}
              </p>
            </div>
        ...
        <div className="Hsection6_Sec_three ">
          ...
          <div className="Hsection6_join_live_last ">
            <p> Join The Challenge Now!</p>
            <p>
